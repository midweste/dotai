...
- Practice red → green → refactor for behavioral changes: start with a failing automated test, make it pass, then clean up. Documentation or comment-only fixes may skip test-first.

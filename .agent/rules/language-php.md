...
Never use `as` aliases (e.g., `use Namespace\Class as Alias;`) unless there is a direct name collision within the same file. Always prefer the original short class name.
